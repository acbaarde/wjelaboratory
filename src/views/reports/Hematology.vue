<template>
    ...
    <v-card class="justify-center" max-width="800px">
        <result-header />
        <v-divider></v-divider>
        <v-card-text>
            <v-container>
                        ...
                        <table style="width:100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2" colspan="1">0.38</td>
