                        ...
                        <v-container class="pa-0 py-2">
                          <v-row no-gutters>
                            ...
                            <v-col cols="6" class="pl-2">
                              ...
                              <v-text-field v-model="active_item.contact" dense outlined type="text" label="Contact #." required :rules="contactRules"></v-text-field>
                        ...
                        <v-container class="pa-0 py-2">
                          <v-row no-gutters>
                            ...
                            <v-col cols="6" class="pl-2">
                              ...
                              <v-text-field v-model="active_item.sss_no" dense outlined type="text" label="SSS #."></v-text-field>
                              <v-text-field v-model="active_item.tin_no" dense outlined type="text" label="TIN #."></v-text-field>
                              <v-text-field v-model="active_item.hdmf_no" dense outlined type="text" label="HDMF #."></v-text-field>
                              <v-text-field v-model="active_item.philhealth_no" dense outlined type="text" label="Philhealth #."></v-text-field>
                            </v-col>
                          </v-row>
                        </v-container>
                      </v-stepper-content>
